...
<div class="container-fluid">
  ...
  <form method="POST" action="{{ route('admin.category.update', $categoria->id) }}">  
      {{ csrf_field() }}
      {{ method_field('PUT') }}

      <div class="page-head">
        <h2 class="page-title float-left">Editar Categoría</h2>
                    ...
                    <div class="col-sm-12">
                        <div class="form-row">
                          <div class="form-group col-6">
                            ...
                            <div>
                              <input class="form-control" value="{{ $categoria->nombre }}" name="nombre" type="text" id="nombre">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="desc">Descripción</label>
                          <textarea class="form-control" name="desc" id="desc" rows="5" col="8">{{ $categoria->desc }}</textarea>
                        </div>
