...
<div class="container-fluid">
      ...
      <div class="page-head">
        <h2 class="page-title float-left">Notas</h2>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group float-right">
                              <a class="btn btn-default btn-action" href="{!! URL::route('notes.edit', $nota->id) !!}"><i class="fas fa-pencil-alt"></i> Modificar</a>
                              ...
                              <ul class="dropdown-menu">
                                <a class="dropdown-item remove-artist" data-toggle="modal" data-url="{{ route('notes.destroy', $nota->id) }}" data-id="{{ $nota->id }}" data-target="#confirm_delete_artist" href="#"><i class="fas fa-trash-alt"></i> Eliminar</a>
                              </ul>
                          </div>
                        </td>
                      </tr>
