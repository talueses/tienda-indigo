@include('mails.layouts.header', ['title' => "Costo de envío actualizado"])
<!-- BEGIN TEMPLATE // -->
                    ...
                    <tbody>
  						        <tr>
          							<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
          								...
          								<p>
          								<br>
          								El costo de env&iacute;o en su lista de regalo {{ $lista->codigo }} en Galería Indigo ha sido actualizada.

          								<br><br>
          								El costo de su lista es: <b>S/ {{ $lista->costo_envio }}</b>
          								</p>
