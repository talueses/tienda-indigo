                    ...
                    <tbody>
  						        <tr>
          							<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
          								...
          								<p>
          								<br>
          								Su cuenta de regalos ha sido creada, inicie sesión para poder comenzar a crear una lista:
          						...
          						<tbody>
          							<tr>
          								<td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica;font-size: 18px;padding: 18px;background-color: white;border: 2px solid black;">
            									<a class="mcnButton " title="Iniciar Sesión" href="{{Request::root()}}/programa-de-regalos/" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #101010;">Iniciar Sesión</a>
          								</td>
          							</tr>
          						</tbody>
          					</table>
