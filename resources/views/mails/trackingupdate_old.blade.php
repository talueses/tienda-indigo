...
<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
    ...
    <h2 style="font-size: 26px;">Se ha actualizado su orden</h2>

    <p>
      Su orden ya cuenta con c&oacute;digo de seguimiento:
    </p>
    ...
    <table class="mcnOrderProducts" style="border-collapse: collapse;width: 100%;">
      ...
      <div style="background-color:#ffc107;color:white;padding: 5px 10px;">
                  ...
                  <tbody>
                    <tr>
                      <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica;font-size: 18px;padding: 18px;background-color: white;border: 2px solid black;">
                          <a class="mcnButton " title="Completar Pago" href="{{ $route }}" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #101010;">Ver detalle</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
