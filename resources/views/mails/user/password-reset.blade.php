                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                ...
                                                <p>
                                                    <br>
                                                    Ha solicitado un cambio de contraseña para su cuenta.

                                                    <br><br>
                                                    Si usted no ha solicitado un restablecimiento de contraseña,
                                                    <br>
                                                    por favor ignore este mensaje.

                                                    <br><br>
                                                    Haga click en el enlace de reestablecimiento de contraseña o
                                                    <br>cópielo y péguelo en su navegador web:
                                                </p>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #00ADD8;">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" class="mcnButtonContent">
                                                <a title="Resetear contraseña" href="{{ $link }}" target="_blank">{{ $link }}</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
