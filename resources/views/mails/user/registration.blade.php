@include('mails.layouts.header', ['title' => "Registro de Cuenta"])
                    ...
                    <tbody>
						<tr>
							...
							<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
								...
								<p>
								<br>
								Gracias por unirte a la Galer&iacute;a Indigo. Tu cuenta ha sido creada y ya puedes iniciar sesión.
									
								<br><br>
								Para ingresar a tu cuenta haz click aquí:
								</p>
						...
						<tbody>
							<tr>
								<td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica;font-size: 18px;padding: 18px;background-color: white;border: 2px solid black;">
									<a class="mcnButton " title="Iniciar Sesión" href="{{Request::root()}}/login" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #101010;">Iniciar Sesión</a>
								</td>
							</tr>
						</tbody>
					</table>
