<div class="modal modal-cart fade" id="modal_gift_cart" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                  <i class="fas fa-check"></i> <span class="title ml-2">Se ha agregado el regalo al carrito de compras</span>
                </div>

                <div class="col-6">
                    <div class="product-image-container layer_cart_img">
                        <img id="modal_cart_gift_img" class="img-fluid" src="" alt="">
                    </div>
                </div>
                ...
                <div class="col-6">
                  ...
                  <div class="layer_cart_product_info">
                      <div class="">
                        <span id="layer_cart_gift_title">Item</span>
                      </div>

                      <div class="">
                        <strong>Cantidad:</strong>
                        <span id="layer_cart_gift_quantity">0</span>
                      </div>

                      <div class="">
                        <strong>Precio:</strong> <!-- Precio -->
                        S./<span id="layer_cart_gift_price">0</span>
                      </div>
                  </div>
